...
// Important
let ServerID = '502500840452653066'; // Server ID ( Right click your server Icon > Copy ID > Place here.) IMPORTANT.
let ServerName = 'Project Day'; // Server name 
let Activity = 'Hey you!'; // What the bot is playing
let PREFIX = 'pd!'; // Change me if you wish too

let AdminRoleName = 'Admin'; // Change me to the Admin role of your server ( EXACT SAME NAME )
...
let SupportChannelCatagoryID = '530992618340089856'; // Support Ticket Catagory ( Create a new catagory > Right Click > CopyID > Paste here) IMPORTANT.
